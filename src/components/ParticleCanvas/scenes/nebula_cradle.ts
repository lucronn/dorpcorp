...
export function buildNebulaCradleScene(
  ...
  entities.push({
    ...
    secondaryColor: "#ffd778",
    orbitRadius: radius1,
    orbitAngle: angle1,
    orbitSpeed: 0.004,
    centerX: cx,
    centerY: cy,
    vx: -Math.sin(angle1) * radius1 * 0.004 * 1.5,
    vy: Math.cos(angle1) * radius1 * 0.004 * 1.5,
  ...
  entities.push({
    ...
    centerX: cx,
    centerY: cy,
    vx: -Math.sin(angle2) * radius1 * 0.004 * 1.5,
    vy: Math.cos(angle2) * radius1 * 0.004 * 1.5,
